...
namespace Bulkan
{
	...
	public enum VkPipelineCacheCreateFlags : uint32
	{
		...
		// Pretty names
		eExternallySynchronizedBit = .VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT,
	...
	public enum VkQueueFlags : uint32
	{
		...
		// Pretty names
		eGraphicsBit = .VK_QUEUE_GRAPHICS_BIT,
		eComputeBit = .VK_QUEUE_COMPUTE_BIT,
		eTransferBit = .VK_QUEUE_TRANSFER_BIT,
		eSparseBindingBit = .VK_QUEUE_SPARSE_BINDING_BIT,
		eProtectedBit = .VK_QUEUE_PROTECTED_BIT,
		eVideoDecodeBitKhr = .VK_QUEUE_VIDEO_DECODE_BIT_KHR,
		eVideoEncodeBitKhr = .VK_QUEUE_VIDEO_ENCODE_BIT_KHR,
	...
	public enum VkCullModeFlags : uint32
	{
		...
		eFrontBit = .VK_CULL_MODE_FRONT_BIT,
		eBackBit = .VK_CULL_MODE_BACK_BIT,
	...
	public enum VkRenderPassCreateFlags : uint32
	{
		...
		// Pretty names
		eTransformBitQcom = .VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM,
	...
	public enum VkDeviceQueueCreateFlags : uint32
	{
		...
		// Pretty names
		eProtectedBit = .VK_DEVICE_QUEUE_CREATE_PROTECTED_BIT,
	...
	public enum VkMemoryPropertyFlags : uint32
	{
		...
		// Pretty names
		eDeviceLocalBit = .VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
		eHostVisibleBit = .VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT,
		eHostCoherentBit = .VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
		eHostCachedBit = .VK_MEMORY_PROPERTY_HOST_CACHED_BIT,
		eLazilyAllocatedBit = .VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT,
		eProtectedBit = .VK_MEMORY_PROPERTY_PROTECTED_BIT,
		eDeviceCoherentBitAmd = .VK_MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD,
		eDeviceUncachedBitAmd = .VK_MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD,
		eRdmaCapableBitNv = .VK_MEMORY_PROPERTY_RDMA_CAPABLE_BIT_NV,
	...
	public enum VkMemoryHeapFlags : uint32
	{
		...
		// Pretty names
		eDeviceLocalBit = .VK_MEMORY_HEAP_DEVICE_LOCAL_BIT,
		eMultiInstanceBit = .VK_MEMORY_HEAP_MULTI_INSTANCE_BIT,
	...
	public enum VkAccessFlags : uint32
	{
		...
		// Pretty names
		eIndirectCommandReadBit = .VK_ACCESS_INDIRECT_COMMAND_READ_BIT,
		eIndexReadBit = .VK_ACCESS_INDEX_READ_BIT,
		eVertexAttributeReadBit = .VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT,
		eUniformReadBit = .VK_ACCESS_UNIFORM_READ_BIT,
		eInputAttachmentReadBit = .VK_ACCESS_INPUT_ATTACHMENT_READ_BIT,
		eShaderReadBit = .VK_ACCESS_SHADER_READ_BIT,
		eShaderWriteBit = .VK_ACCESS_SHADER_WRITE_BIT,
		eColorAttachmentReadBit = .VK_ACCESS_COLOR_ATTACHMENT_READ_BIT,
		eColorAttachmentWriteBit = .VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT,
		eDepthStencilAttachmentReadBit = .VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT,
		eDepthStencilAttachmentWriteBit = .VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT,
		eTransferReadBit = .VK_ACCESS_TRANSFER_READ_BIT,
		eTransferWriteBit = .VK_ACCESS_TRANSFER_WRITE_BIT,
		eHostReadBit = .VK_ACCESS_HOST_READ_BIT,
		eHostWriteBit = .VK_ACCESS_HOST_WRITE_BIT,
		eMemoryReadBit = .VK_ACCESS_MEMORY_READ_BIT,
		eMemoryWriteBit = .VK_ACCESS_MEMORY_WRITE_BIT,
		eNone = .VK_ACCESS_NONE,
		eTransformFeedbackWriteBitEXT = .VK_ACCESS_TRANSFORM_FEEDBACK_WRITE_BIT_EXT,
		eTransformFeedbackCounterReadBitEXT = .VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT,
		eTransformFeedbackCounterWriteBitEXT = .VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT,
		eConditionalRenderingReadBitEXT = .VK_ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT,
		eColorAttachmentReadNoncoherentBitEXT = .VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT,
		eAccelerationStructureReadBitKhr = .VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR,
		eAccelerationStructureWriteBitKhr = .VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR,
		eFragmentDensityMapReadBitEXT = .VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT,
		eFragmentShadingRateAttachmentReadBitKhr = .VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR,
		eCommandPreprocessReadBitNv = .VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV,
		eCommandPreprocessWriteBitNv = .VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV,
	...
	public enum VkBufferUsageFlags : uint32
	{
		...
		// Pretty names
		eTransferSrcBit = .VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
		eTransferDstBit = .VK_BUFFER_USAGE_TRANSFER_DST_BIT,
		eUniformTexelBufferBit = .VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT,
		eStorageTexelBufferBit = .VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT,
		eUniformBufferBit = .VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
		eStorageBufferBit = .VK_BUFFER_USAGE_STORAGE_BUFFER_BIT,
		eIndexBufferBit = .VK_BUFFER_USAGE_INDEX_BUFFER_BIT,
		eVertexBufferBit = .VK_BUFFER_USAGE_VERTEX_BUFFER_BIT,
		eIndirectBufferBit = .VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT,
		eShaderDeviceAddressBit = .VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
		eVideoDecodeSrcBitKhr = .VK_BUFFER_USAGE_VIDEO_DECODE_SRC_BIT_KHR,
		eVideoDecodeDstBitKhr = .VK_BUFFER_USAGE_VIDEO_DECODE_DST_BIT_KHR,
		eTransformFeedbackBufferBitEXT = .VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT,
		eTransformFeedbackCounterBufferBitEXT = .VK_BUFFER_USAGE_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT,
		eConditionalRenderingBitEXT = .VK_BUFFER_USAGE_CONDITIONAL_RENDERING_BIT_EXT,
		eAccelerationStructureBuildInputReadOnlyBitKhr = .VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR,
		eAccelerationStructureStorageBitKhr = .VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR,
		eShaderBindingTableBitKhr = .VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR,
		eVideoEncodeDstBitKhr = .VK_BUFFER_USAGE_VIDEO_ENCODE_DST_BIT_KHR,
		eVideoEncodeSrcBitKhr = .VK_BUFFER_USAGE_VIDEO_ENCODE_SRC_BIT_KHR,
	...
	public enum VkBufferCreateFlags : uint32
	{
		...
		// Pretty names
		eSparseBindingBit = .VK_BUFFER_CREATE_SPARSE_BINDING_BIT,
		eSparseResidencyBit = .VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT,
		eSparseAliasedBit = .VK_BUFFER_CREATE_SPARSE_ALIASED_BIT,
		eProtectedBit = .VK_BUFFER_CREATE_PROTECTED_BIT,
		eDeviceAddressCaptureReplayBit = .VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,
	...
	public enum VkShaderStageFlags : uint32
	{
		...
		// Pretty names
		eVertexBit = .VK_SHADER_STAGE_VERTEX_BIT,
		eTessellationControlBit = .VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT,
		eTessellationEvaluationBit = .VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT,
		eGeometryBit = .VK_SHADER_STAGE_GEOMETRY_BIT,
		eFragmentBit = .VK_SHADER_STAGE_FRAGMENT_BIT,
		eComputeBit = .VK_SHADER_STAGE_COMPUTE_BIT,
		eAllGraphics = .VK_SHADER_STAGE_ALL_GRAPHICS,
		eAll = .VK_SHADER_STAGE_ALL,
		eRaygenBitKhr = .VK_SHADER_STAGE_RAYGEN_BIT_KHR,
		eAnyHitBitKhr = .VK_SHADER_STAGE_ANY_HIT_BIT_KHR,
		eClosestHitBitKhr = .VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR,
		eMissBitKhr = .VK_SHADER_STAGE_MISS_BIT_KHR,
		eIntersectionBitKhr = .VK_SHADER_STAGE_INTERSECTION_BIT_KHR,
		eCallableBitKhr = .VK_SHADER_STAGE_CALLABLE_BIT_KHR,
		eTaskBitNv = .VK_SHADER_STAGE_TASK_BIT_NV,
		eMeshBitNv = .VK_SHADER_STAGE_MESH_BIT_NV,
		eSubpassShadingBitHuawei = .VK_SHADER_STAGE_SUBPASS_SHADING_BIT_HUAWEI,
	...
	public enum VkImageUsageFlags : uint32
	{
		...
		// Pretty names
		eTransferSrcBit = .VK_IMAGE_USAGE_TRANSFER_SRC_BIT,
		eTransferDstBit = .VK_IMAGE_USAGE_TRANSFER_DST_BIT,
		eSampledBit = .VK_IMAGE_USAGE_SAMPLED_BIT,
		eStorageBit = .VK_IMAGE_USAGE_STORAGE_BIT,
		eColorAttachmentBit = .VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT,
		eDepthStencilAttachmentBit = .VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT,
		eTransientAttachmentBit = .VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT,
		eInputAttachmentBit = .VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT,
		eVideoDecodeDstBitKhr = .VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR,
		eVideoDecodeSrcBitKhr = .VK_IMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHR,
		eVideoDecodeDpbBitKhr = .VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR,
		eFragmentDensityMapBitEXT = .VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT,
		eFragmentShadingRateAttachmentBitKhr = .VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR,
		eVideoEncodeDstBitKhr = .VK_IMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHR,
		eVideoEncodeSrcBitKhr = .VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR,
		eVideoEncodeDpbBitKhr = .VK_IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR,
		eInvocationMaskBitHuawei = .VK_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI,
		eSampleWeightBitQcom = .VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM,
		eSampleBlockMatchBitQcom = .VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM,
	...
	public enum VkImageCreateFlags : uint32
	{
		...
		// Pretty names
		eSparseBindingBit = .VK_IMAGE_CREATE_SPARSE_BINDING_BIT,
		eSparseResidencyBit = .VK_IMAGE_CREATE_SPARSE_RESIDENCY_BIT,
		eSparseAliasedBit = .VK_IMAGE_CREATE_SPARSE_ALIASED_BIT,
		eMutableFormatBit = .VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT,
		eCubeCompatibleBit = .VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT,
		eAliasBit = .VK_IMAGE_CREATE_ALIAS_BIT,
		eSplitInstanceBindRegionsBit = .VK_IMAGE_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT,
		e2dArrayCompatibleBit = .VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT,
		eBlockTexelViewCompatibleBit = .VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT,
		eExtendedUsageBit = .VK_IMAGE_CREATE_EXTENDED_USAGE_BIT,
		eProtectedBit = .VK_IMAGE_CREATE_PROTECTED_BIT,
		eDisjointBit = .VK_IMAGE_CREATE_DISJOINT_BIT,
		eCornerSampledBitNv = .VK_IMAGE_CREATE_CORNER_SAMPLED_BIT_NV,
		eSampleLocationsCompatibleDepthBitEXT = .VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT,
		eSubsampledBitEXT = .VK_IMAGE_CREATE_SUBSAMPLED_BIT_EXT,
		eMultisampledRenderToSingleSampledBitEXT = .VK_IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT,
		e2dViewCompatibleBitEXT = .VK_IMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXT,
		eFragmentDensityMapOffsetBitQcom = .VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_QCOM,
	...
	public enum VkImageViewCreateFlags : uint32
	{
		...
		// Pretty names
		eFragmentDensityMapDynamicBitEXT = .VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT,
		eFragmentDensityMapDeferredBitEXT = .VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT,
	...
	public enum VkSamplerCreateFlags : uint32
	{
		...
		// Pretty names
		eSubsampledBitEXT = .VK_SAMPLER_CREATE_SUBSAMPLED_BIT_EXT,
		eSubsampledCoarseReconstructionBitEXT = .VK_SAMPLER_CREATE_SUBSAMPLED_COARSE_RECONSTRUCTION_BIT_EXT,
		eNonSeamlessCubeMapBitEXT = .VK_SAMPLER_CREATE_NON_SEAMLESS_CUBE_MAP_BIT_EXT,
		eImageProcessingBitQcom = .VK_SAMPLER_CREATE_IMAGE_PROCESSING_BIT_QCOM,
	...
	public enum VkPipelineCreateFlags : uint32
	{
		...
		// Pretty names
		eDisableOptimizationBit = .VK_PIPELINE_CREATE_DISABLE_OPTIMIZATION_BIT,
		eAllowDerivativesBit = .VK_PIPELINE_CREATE_ALLOW_DERIVATIVES_BIT,
		eDerivativeBit = .VK_PIPELINE_CREATE_DERIVATIVE_BIT,
		eViewIndexFromDeviceIndexBit = .VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT,
		eDispatchBaseBit = .VK_PIPELINE_CREATE_DISPATCH_BASE_BIT,
		eFailOnPipelineCompileRequiredBit = .VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT,
		eEarlyReturnOnFailureBit = .VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT,
		eRayTracingNoNullAnyHitShadersBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR,
		eRayTracingNoNullClosestHitShadersBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR,
		eRayTracingNoNullMissShadersBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR,
		eRayTracingNoNullIntersectionShadersBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR,
		eRayTracingSkipTrianglesBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR,
		eRayTracingSkipAabbsBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR,
		eRayTracingShaderGroupHandleCaptureReplayBitKhr = .VK_PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR,
		eDeferCompileBitNv = .VK_PIPELINE_CREATE_DEFER_COMPILE_BIT_NV,
		eCaptureStatisticsBitKhr = .VK_PIPELINE_CREATE_CAPTURE_STATISTICS_BIT_KHR,
		eCaptureInternalRepresentationsBitKhr = .VK_PIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR,
		eIndirectBindableBitNv = .VK_PIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NV,
		eLibraryBitKhr = .VK_PIPELINE_CREATE_LIBRARY_BIT_KHR,
		eRetainLinkTimeOptimizationInfoBitEXT = .VK_PIPELINE_CREATE_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT,
		eLinkTimeOptimizationBitEXT = .VK_PIPELINE_CREATE_LINK_TIME_OPTIMIZATION_BIT_EXT,
		eRayTracingAllowMotionBitNv = .VK_PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV,
	...
	public enum VkPipelineShaderStageCreateFlags : uint32
	{
		...
		// Pretty names
		eAllowVaryingSubgroupSizeBit = .VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT,
		eRequireFullSubgroupsBit = .VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_BIT,
	...
	public enum VkColorComponentFlags : uint32
	{
		...
		// Pretty names
		eRBit = .VK_COLOR_COMPONENT_R_BIT,
		eGBit = .VK_COLOR_COMPONENT_G_BIT,
		eBBit = .VK_COLOR_COMPONENT_B_BIT,
		eABit = .VK_COLOR_COMPONENT_A_BIT,
	...
	public enum VkFenceCreateFlags : uint32
	{
		...
		// Pretty names
		eSignaledBit = .VK_FENCE_CREATE_SIGNALED_BIT,
	...
	public enum VkFormatFeatureFlags : uint32
	{
		...
		// Pretty names
		eSampledImageBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT,
		eStorageImageBit = .VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT,
		eStorageImageAtomicBit = .VK_FORMAT_FEATURE_STORAGE_IMAGE_ATOMIC_BIT,
		eUniformTexelBufferBit = .VK_FORMAT_FEATURE_UNIFORM_TEXEL_BUFFER_BIT,
		eStorageTexelBufferBit = .VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_BIT,
		eStorageTexelBufferAtomicBit = .VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC_BIT,
		eVertexBufferBit = .VK_FORMAT_FEATURE_VERTEX_BUFFER_BIT,
		eColorAttachmentBit = .VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT,
		eColorAttachmentBlendBit = .VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT,
		eDepthStencilAttachmentBit = .VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT,
		eBlitSrcBit = .VK_FORMAT_FEATURE_BLIT_SRC_BIT,
		eBlitDstBit = .VK_FORMAT_FEATURE_BLIT_DST_BIT,
		eSampledImageFilterLinearBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT,
		eTransferSrcBit = .VK_FORMAT_FEATURE_TRANSFER_SRC_BIT,
		eTransferDstBit = .VK_FORMAT_FEATURE_TRANSFER_DST_BIT,
		eMidpointChromaSamplesBit = .VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT,
		eSampledImageYcbcrConversionLinearFilterBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT,
		eSampledImageYcbcrConversionSeparateReconstructionFilterBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT,
		eSampledImageYcbcrConversionChromaReconstructionExplicitBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT,
		eSampledImageYcbcrConversionChromaReconstructionExplicitForceableBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT,
		eDisjointBit = .VK_FORMAT_FEATURE_DISJOINT_BIT,
		eCositedChromaSamplesBit = .VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT,
		eSampledImageFilterMinmaxBit = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT,
		eVideoDecodeOutputBitKhr = .VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR,
		eVideoDecodeDpbBitKhr = .VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR,
		eAccelerationStructureVertexBufferBitKhr = .VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR,
		eSampledImageFilterCubicBitEXT = .VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT,
		eFragmentDensityMapBitEXT = .VK_FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_BIT_EXT,
		eFragmentShadingRateAttachmentBitKhr = .VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR,
		eVideoEncodeInputBitKhr = .VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR,
		eVideoEncodeDpbBitKhr = .VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR,
	...
	public enum VkQueryControlFlags : uint32
	{
		...
		// Pretty names
		ePreciseBit = .VK_QUERY_CONTROL_PRECISE_BIT,
	...
	public enum VkQueryResultFlags : uint32
	{
		...
		// Pretty names
		e64Bit = .VK_QUERY_RESULT_64_BIT,
		eWaitBit = .VK_QUERY_RESULT_WAIT_BIT,
		eWithAvailabilityBit = .VK_QUERY_RESULT_WITH_AVAILABILITY_BIT,
		ePartialBit = .VK_QUERY_RESULT_PARTIAL_BIT,
		eWithStatusBitKhr = .VK_QUERY_RESULT_WITH_STATUS_BIT_KHR,
	...
	public enum VkCommandBufferUsageFlags : uint32
	{
		...
		// Pretty names
		eOneTimeSubmitBit = .VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT,
		eRenderPassContinueBit = .VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT,
		eSimultaneousUseBit = .VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT,
	...
	public enum VkQueryPipelineStatisticFlags : uint32
	{
		...
		// Pretty names
		eInputAssemblyVerticesBit = .VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_VERTICES_BIT,
		eInputAssemblyPrimitivesBit = .VK_QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_PRIMITIVES_BIT,
		eVertexShaderInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_VERTEX_SHADER_INVOCATIONS_BIT,
		eGeometryShaderInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_INVOCATIONS_BIT,
		eGeometryShaderPrimitivesBit = .VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_PRIMITIVES_BIT,
		eClippingInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS_BIT,
		eClippingPrimitivesBit = .VK_QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES_BIT,
		eFragmentShaderInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS_BIT,
		eTessellationControlShaderPatchesBit = .VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_CONTROL_SHADER_PATCHES_BIT,
		eTessellationEvaluationShaderInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT,
		eComputeShaderInvocationsBit = .VK_QUERY_PIPELINE_STATISTIC_COMPUTE_SHADER_INVOCATIONS_BIT,
	...
	public enum VkImageAspectFlags : uint32
	{
		...
		// Pretty names
		eColorBit = .VK_IMAGE_ASPECT_COLOR_BIT,
		eDepthBit = .VK_IMAGE_ASPECT_DEPTH_BIT,
		eStencilBit = .VK_IMAGE_ASPECT_STENCIL_BIT,
		eMetadataBit = .VK_IMAGE_ASPECT_METADATA_BIT,
		ePlane0Bit = .VK_IMAGE_ASPECT_PLANE_0_BIT,
		ePlane1Bit = .VK_IMAGE_ASPECT_PLANE_1_BIT,
		ePlane2Bit = .VK_IMAGE_ASPECT_PLANE_2_BIT,
		eNone = .VK_IMAGE_ASPECT_NONE,
		eMemoryPlane0BitEXT = .VK_IMAGE_ASPECT_MEMORY_PLANE_0_BIT_EXT,
		eMemoryPlane1BitEXT = .VK_IMAGE_ASPECT_MEMORY_PLANE_1_BIT_EXT,
		eMemoryPlane2BitEXT = .VK_IMAGE_ASPECT_MEMORY_PLANE_2_BIT_EXT,
		eMemoryPlane3BitEXT = .VK_IMAGE_ASPECT_MEMORY_PLANE_3_BIT_EXT,
	...
	public enum VkSparseImageFormatFlags : uint32
	{
		...
		// Pretty names
		eSingleMiptailBit = .VK_SPARSE_IMAGE_FORMAT_SINGLE_MIPTAIL_BIT,
		eAlignedMipSizeBit = .VK_SPARSE_IMAGE_FORMAT_ALIGNED_MIP_SIZE_BIT,
		eNonstandardBlockSizeBit = .VK_SPARSE_IMAGE_FORMAT_NONSTANDARD_BLOCK_SIZE_BIT,
	...
	public enum VkSparseMemoryBindFlags : uint32
	{
		...
		// Pretty names
		eMetadataBit = .VK_SPARSE_MEMORY_BIND_METADATA_BIT,
	...
	public enum VkPipelineStageFlags : uint32
	{
		...
		// Pretty names
		eTopOfPipeBit = .VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT,
		eDrawIndirectBit = .VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT,
		eVertexInputBit = .VK_PIPELINE_STAGE_VERTEX_INPUT_BIT,
		eVertexShaderBit = .VK_PIPELINE_STAGE_VERTEX_SHADER_BIT,
		eTessellationControlShaderBit = .VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT,
		eTessellationEvaluationShaderBit = .VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT,
		eGeometryShaderBit = .VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT,
		eFragmentShaderBit = .VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
		eEarlyFragmentTestsBit = .VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT,
		eLateFragmentTestsBit = .VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT,
		eColorAttachmentOutputBit = .VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
		eComputeShaderBit = .VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
		eTransferBit = .VK_PIPELINE_STAGE_TRANSFER_BIT,
		eBottomOfPipeBit = .VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
		eHostBit = .VK_PIPELINE_STAGE_HOST_BIT,
		eAllGraphicsBit = .VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT,
		eAllCommandsBit = .VK_PIPELINE_STAGE_ALL_COMMANDS_BIT,
		eNone = .VK_PIPELINE_STAGE_NONE,
		eTransformFeedbackBitEXT = .VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT,
		eConditionalRenderingBitEXT = .VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT,
		eAccelerationStructureBuildBitKhr = .VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR,
		eRayTracingShaderBitKhr = .VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR,
		eTaskShaderBitNv = .VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV,
		eMeshShaderBitNv = .VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV,
		eFragmentDensityProcessBitEXT = .VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT,
		eFragmentShadingRateAttachmentBitKhr = .VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR,
		eCommandPreprocessBitNv = .VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV,
	...
	public enum VkCommandPoolCreateFlags : uint32
	{
		...
		// Pretty names
		eTransientBit = .VK_COMMAND_POOL_CREATE_TRANSIENT_BIT,
		eResetCommandBufferBit = .VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT,
		eProtectedBit = .VK_COMMAND_POOL_CREATE_PROTECTED_BIT,
	...
	public enum VkCommandPoolResetFlags : uint32
	{
		...
		// Pretty names
		eReleaseResourcesBit = .VK_COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT,
	...
	public enum VkCommandBufferResetFlags : uint32
	{
		...
		// Pretty names
		eReleaseResourcesBit = .VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT,
	...
	public enum VkSampleCountFlags : uint32
	{
		...
		// Pretty names
		e1Bit = .VK_SAMPLE_COUNT_1_BIT,
		e2Bit = .VK_SAMPLE_COUNT_2_BIT,
		e4Bit = .VK_SAMPLE_COUNT_4_BIT,
		e8Bit = .VK_SAMPLE_COUNT_8_BIT,
		e16Bit = .VK_SAMPLE_COUNT_16_BIT,
		e32Bit = .VK_SAMPLE_COUNT_32_BIT,
		e64Bit = .VK_SAMPLE_COUNT_64_BIT,
	...
	public enum VkAttachmentDescriptionFlags : uint32
	{
		...
		// Pretty names
		eMayAliasBit = .VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT,
	...
	public enum VkStencilFaceFlags : uint32
	{
		...
		// Pretty names
		eFrontBit = .VK_STENCIL_FACE_FRONT_BIT,
		eBackBit = .VK_STENCIL_FACE_BACK_BIT,
	...
	public enum VkDescriptorPoolCreateFlags : uint32
	{
		...
		// Pretty names
		eFreeDescriptorSetBit = .VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT,
		eUpdateAfterBindBit = .VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT,
		eHostOnlyBitValve = .VK_DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_VALVE,
	...
	public enum VkDependencyFlags : uint32
	{
		...
		// Pretty names
		eByRegionBit = .VK_DEPENDENCY_BY_REGION_BIT,
		eDeviceGroupBit = .VK_DEPENDENCY_DEVICE_GROUP_BIT,
		eViewLocalBit = .VK_DEPENDENCY_VIEW_LOCAL_BIT,
	...
	public enum VkSemaphoreWaitFlags : uint32
	{
		...
		// Pretty names
		eAnyBit = .VK_SEMAPHORE_WAIT_ANY_BIT,
	...
	public enum VkDebugReportFlagsEXT : uint32
	{
		...
		// Pretty names
		eInformationBitEXT = .VK_DEBUG_REPORT_INFORMATION_BIT_EXT,
		eWarningBitEXT = .VK_DEBUG_REPORT_WARNING_BIT_EXT,
		ePerformanceWarningBitEXT = .VK_DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT,
		eErrorBitEXT = .VK_DEBUG_REPORT_ERROR_BIT_EXT,
		eDebugBitEXT = .VK_DEBUG_REPORT_DEBUG_BIT_EXT,
	...
	public enum VkDebugReportObjectTypeEXT : uint32
	{
		...
		eDebugReportCallbackExtEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_DEBUG_REPORT_CALLBACK_EXT_EXT,
		eDebugReportEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_DEBUG_REPORT_EXT,
		eDisplayKhrEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_KHR_EXT,
		eDisplayModeKhrEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_DISPLAY_MODE_KHR_EXT,
		eValidationCacheExtEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT,
		eValidationCacheEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT,
		eCuModuleNvxEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_CU_MODULE_NVX_EXT,
		eCuFunctionNvxEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_CU_FUNCTION_NVX_EXT,
		eAccelerationStructureKhrEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR_EXT,
		eAccelerationStructureNvEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_NV_EXT,
		eBufferCollectionFuchsiaEXT = .VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_COLLECTION_FUCHSIA_EXT,
	...
	public enum VkDeviceMemoryReportEventTypeEXT : uint32
	{
		...
		// Pretty names
		eAllocateEXT = .VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT,
		eFreeEXT = .VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_FREE_EXT,
		eImportEXT = .VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT,
		eUnimportEXT = .VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_UNIMPORT_EXT,
		eAllocationFailedEXT = .VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATION_FAILED_EXT,
	...
	public enum VkValidationCheckEXT : uint32
	{
		...
		// Pretty names
		eAllEXT = .VK_VALIDATION_CHECK_ALL_EXT,
		eShadersEXT = .VK_VALIDATION_CHECK_SHADERS_EXT,
	...
	public enum VkValidationFeatureEnableEXT : uint32
	{
		...
		// Pretty names
		eGpuAssistedEXT = .VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_EXT,
		eGpuAssistedReserveBindingSlotEXT = .VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_RESERVE_BINDING_SLOT_EXT,
		eBestPracticesEXT = .VK_VALIDATION_FEATURE_ENABLE_BEST_PRACTICES_EXT,
		eDebugPrintfEXT = .VK_VALIDATION_FEATURE_ENABLE_DEBUG_PRINTF_EXT,
		eSynchronizationValidationEXT = .VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT,
	...
	public enum VkValidationFeatureDisableEXT : uint32
	{
		...
		// Pretty names
		eAllEXT = .VK_VALIDATION_FEATURE_DISABLE_ALL_EXT,
		eShadersEXT = .VK_VALIDATION_FEATURE_DISABLE_SHADERS_EXT,
		eThreadSafetyEXT = .VK_VALIDATION_FEATURE_DISABLE_THREAD_SAFETY_EXT,
		eApiParametersEXT = .VK_VALIDATION_FEATURE_DISABLE_API_PARAMETERS_EXT,
		eObjectLifetimesEXT = .VK_VALIDATION_FEATURE_DISABLE_OBJECT_LIFETIMES_EXT,
		eCoreChecksEXT = .VK_VALIDATION_FEATURE_DISABLE_CORE_CHECKS_EXT,
		eUniqueHandlesEXT = .VK_VALIDATION_FEATURE_DISABLE_UNIQUE_HANDLES_EXT,
		eShaderValidationCacheEXT = .VK_VALIDATION_FEATURE_DISABLE_SHADER_VALIDATION_CACHE_EXT,
	...
	public enum VkSubgroupFeatureFlags : uint32
	{
		...
		// Pretty names
		eBasicBit = .VK_SUBGROUP_FEATURE_BASIC_BIT,
		eVoteBit = .VK_SUBGROUP_FEATURE_VOTE_BIT,
		eArithmeticBit = .VK_SUBGROUP_FEATURE_ARITHMETIC_BIT,
		eBallotBit = .VK_SUBGROUP_FEATURE_BALLOT_BIT,
		eShuffleBit = .VK_SUBGROUP_FEATURE_SHUFFLE_BIT,
		eShuffleRelativeBit = .VK_SUBGROUP_FEATURE_SHUFFLE_RELATIVE_BIT,
		eClusteredBit = .VK_SUBGROUP_FEATURE_CLUSTERED_BIT,
		eQuadBit = .VK_SUBGROUP_FEATURE_QUAD_BIT,
		ePartitionedBitNv = .VK_SUBGROUP_FEATURE_PARTITIONED_BIT_NV,
	...
	public enum VkDescriptorSetLayoutCreateFlags : uint32
	{
		...
		// Pretty names
		eUpdateAfterBindPoolBit = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT,
		ePushDescriptorBitKhr = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT_KHR,
		eHostOnlyPoolBitValve = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_VALVE,
	...
	public enum VkExternalMemoryHandleTypeFlags : uint32
	{
		...
		// Pretty names
		eOpaqueFdBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT,
		eOpaqueWiN32Bit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT,
		eOpaqueWiN32KmtBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT,
		eD3D11TextureBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT,
		eD3D11TextureKmtBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT,
		eD3D12HeapBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT,
		eD3D12ResourceBit = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT,
		eDmaBufBitEXT = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_BIT_EXT,
		eAndroidHardwareBufferBitAndroid = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_BIT_ANDROID,
		eHostAllocationBitEXT = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT,
		eHostMappedForeignMemoryBitEXT = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_MAPPED_FOREIGN_MEMORY_BIT_EXT,
		eZirconVmoBitFuchsia = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA,
		eRdmaAddressBitNv = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_RDMA_ADDRESS_BIT_NV,
	...
	public enum VkExternalMemoryFeatureFlags : uint32
	{
		...
		// Pretty names
		eDedicatedOnlyBit = .VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT,
		eExportableBit = .VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT,
		eImportableBit = .VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT,
	...
	public enum VkExternalSemaphoreHandleTypeFlags : uint32
	{
		...
		// Pretty names
		eOpaqueFdBit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT,
		eOpaqueWiN32Bit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT,
		eOpaqueWiN32KmtBit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT,
		eD3D12FenceBit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT,
		eD3D11FenceBit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D11_FENCE_BIT,
		eSyncFdBit = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SYNC_FD_BIT,
		eZirconEventBitFuchsia = .VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_ZIRCON_EVENT_BIT_FUCHSIA,
	...
	public enum VkExternalSemaphoreFeatureFlags : uint32
	{
		...
		// Pretty names
		eExportableBit = .VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT,
		eImportableBit = .VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT,
	...
	public enum VkSemaphoreImportFlags : uint32
	{
		...
		// Pretty names
		eTemporaryBit = .VK_SEMAPHORE_IMPORT_TEMPORARY_BIT,
	...
	public enum VkExternalFenceHandleTypeFlags : uint32
	{
		...
		// Pretty names
		eOpaqueFdBit = .VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT,
		eOpaqueWiN32Bit = .VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT,
		eOpaqueWiN32KmtBit = .VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT,
		eSyncFdBit = .VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT,
	...
	public enum VkExternalFenceFeatureFlags : uint32
	{
		...
		// Pretty names
		eExportableBit = .VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT,
		eImportableBit = .VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT,
	...
	public enum VkFenceImportFlags : uint32
	{
		...
		// Pretty names
		eTemporaryBit = .VK_FENCE_IMPORT_TEMPORARY_BIT,
	...
	public enum VkSurfaceCounterFlagsEXT : uint32
	{
		...
		// Pretty names
		eVblankBitEXT = .VK_SURFACE_COUNTER_VBLANK_BIT_EXT,
	...
	public enum VkDisplayPowerStateEXT : uint32
	{
		...
		// Pretty names
		eOffEXT = .VK_DISPLAY_POWER_STATE_OFF_EXT,
		eSuspendEXT = .VK_DISPLAY_POWER_STATE_SUSPEND_EXT,
		eOnEXT = .VK_DISPLAY_POWER_STATE_ON_EXT,
	...
	public enum VkDeviceEventTypeEXT : uint32
	{
		...
		// Pretty names
		eDisplayHotplugEXT = .VK_DEVICE_EVENT_TYPE_DISPLAY_HOTPLUG_EXT,
	...
	public enum VkDisplayEventTypeEXT : uint32
	{
		...
		// Pretty names
		eFirstPixelOutEXT = .VK_DISPLAY_EVENT_TYPE_FIRST_PIXEL_OUT_EXT,
	...
	public enum VkPeerMemoryFeatureFlags : uint32
	{
		...
		// Pretty names
		eCopySrcBit = .VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT,
		eCopyDstBit = .VK_PEER_MEMORY_FEATURE_COPY_DST_BIT,
		eGenericSrcBit = .VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT,
		eGenericDstBit = .VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT,
	...
	public enum VkMemoryAllocateFlags : uint32
	{
		...
		// Pretty names
		eDeviceMaskBit = .VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT,
		eDeviceAddressBit = .VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT,
		eDeviceAddressCaptureReplayBit = .VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,
	...
	public enum VkDiscardRectangleModeEXT : uint32
	{
		...
		// Pretty names
		eInclusiveEXT = .VK_DISCARD_RECTANGLE_MODE_INCLUSIVE_EXT,
		eExclusiveEXT = .VK_DISCARD_RECTANGLE_MODE_EXCLUSIVE_EXT,
	...
	public enum VkSubpassDescriptionFlags : uint32
	{
		...
		// Pretty names
		ePerViewAttributesBitNvx = .VK_SUBPASS_DESCRIPTION_PER_VIEW_ATTRIBUTES_BIT_NVX,
		ePerViewPositionXOnlyBitNvx = .VK_SUBPASS_DESCRIPTION_PER_VIEW_POSITION_X_ONLY_BIT_NVX,
		eFragmentRegionBitQcom = .VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM,
		eShaderResolveBitQcom = .VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM,
		eRasterizationOrderAttachmentColorAccessBitArm = .VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_ARM,
		eRasterizationOrderAttachmentDepthAccessBitArm = .VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_ARM,
		eRasterizationOrderAttachmentStencilAccessBitArm = .VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_ARM,
	...
	public enum VkBlendOverlapEXT : uint32
	{
		...
		// Pretty names
		eUncorrelatedEXT = .VK_BLEND_OVERLAP_UNCORRELATED_EXT,
		eDisjointEXT = .VK_BLEND_OVERLAP_DISJOINT_EXT,
		eConjointEXT = .VK_BLEND_OVERLAP_CONJOINT_EXT,
	...
	public enum VkValidationCacheHeaderVersionEXT : uint32
	{
		...
		// Pretty names
		eOneEXT = .VK_VALIDATION_CACHE_HEADER_VERSION_ONE_EXT,
	...
	public enum VkDebugUtilsMessageSeverityFlagsEXT : uint32
	{
		...
		// Pretty names
		eVerboseBitEXT = .VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT,
		eInfoBitEXT = .VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT,
		eWarningBitEXT = .VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT,
		eErrorBitEXT = .VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT,
	...
	public enum VkDebugUtilsMessageTypeFlagsEXT : uint32
	{
		...
		// Pretty names
		eGeneralBitEXT = .VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT,
		eValidationBitEXT = .VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT,
		ePerformanceBitEXT = .VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT,
	...
	public enum VkConservativeRasterizationModeEXT : uint32
	{
		...
		// Pretty names
		eDisabledEXT = .VK_CONSERVATIVE_RASTERIZATION_MODE_DISABLED_EXT,
		eOverestimateEXT = .VK_CONSERVATIVE_RASTERIZATION_MODE_OVERESTIMATE_EXT,
		eUnderestimateEXT = .VK_CONSERVATIVE_RASTERIZATION_MODE_UNDERESTIMATE_EXT,
	...
	public enum VkDescriptorBindingFlags : uint32
	{
		...
		// Pretty names
		eUpdateAfterBindBit = .VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT,
		eUpdateUnusedWhilePendingBit = .VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT,
		ePartiallyBoundBit = .VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT,
		eVariableDescriptorCountBit = .VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT,
	...
	public enum VkConditionalRenderingFlagsEXT : uint32
	{
		...
		// Pretty names
		eInvertedBitEXT = .VK_CONDITIONAL_RENDERING_INVERTED_BIT_EXT,
	...
	public enum VkResolveModeFlags : uint32
	{
		...
		eSampleZeroBit = .VK_RESOLVE_MODE_SAMPLE_ZERO_BIT,
		eAverageBit = .VK_RESOLVE_MODE_AVERAGE_BIT,
		eMinBit = .VK_RESOLVE_MODE_MIN_BIT,
		eMaxBit = .VK_RESOLVE_MODE_MAX_BIT,
	...
	public enum VkFramebufferCreateFlags : uint32
	{
		...
		// Pretty names
		eImagelessBit = .VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT,
	...
	public enum VkPipelineCreationFeedbackFlags : uint32
	{
		...
		// Pretty names
		eValidBit = .VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT,
		eValidBitEXT = .VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT_EXT,
		eApplicationPipelineCacheHitBit = .VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT,
		eApplicationPipelineCacheHitBitEXT = .VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT_EXT,
		eBasePipelineAccelerationBit = .VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT,
		eBasePipelineAccelerationBitEXT = .VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT_EXT,
	...
	public enum VkFullScreenExclusiveEXT : uint32
	{
		...
		// Pretty names
		eDefaultEXT = .VK_FULL_SCREEN_EXCLUSIVE_DEFAULT_EXT,
		eAllowedEXT = .VK_FULL_SCREEN_EXCLUSIVE_ALLOWED_EXT,
		eDisallowedEXT = .VK_FULL_SCREEN_EXCLUSIVE_DISALLOWED_EXT,
		eApplicationControlledEXT = .VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT,
	...
	public enum VkToolPurposeFlags : uint32
	{
		...
		// Pretty names
		eValidationBit = .VK_TOOL_PURPOSE_VALIDATION_BIT,
		eValidationBitEXT = .VK_TOOL_PURPOSE_VALIDATION_BIT_EXT,
		eProfilingBit = .VK_TOOL_PURPOSE_PROFILING_BIT,
		eProfilingBitEXT = .VK_TOOL_PURPOSE_PROFILING_BIT_EXT,
		eTracingBit = .VK_TOOL_PURPOSE_TRACING_BIT,
		eTracingBitEXT = .VK_TOOL_PURPOSE_TRACING_BIT_EXT,
		eAdditionalFeaturesBit = .VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT,
		eAdditionalFeaturesBitEXT = .VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT,
		eModifyingFeaturesBit = .VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT,
		eModifyingFeaturesBitEXT = .VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT,
	...
	public enum VkSubpassMergeStatusEXT : uint32
	{
		...
		// Pretty names
		eMergedEXT = .VK_SUBPASS_MERGE_STATUS_MERGED_EXT,
		eDisallowedEXT = .VK_SUBPASS_MERGE_STATUS_DISALLOWED_EXT,
		eNotMergedSideEffectsEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_SIDE_EFFECTS_EXT,
		eNotMergedSamplesMismatchEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_SAMPLES_MISMATCH_EXT,
		eNotMergedViewsMismatchEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_VIEWS_MISMATCH_EXT,
		eNotMergedAliasingEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_ALIASING_EXT,
		eNotMergedDependenciesEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_DEPENDENCIES_EXT,
		eNotMergedIncompatibleInputAttachmentEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_INCOMPATIBLE_INPUT_ATTACHMENT_EXT,
		eNotMergedTooManyAttachmentsEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_TOO_MANY_ATTACHMENTS_EXT,
		eNotMergedInsufficientStorageEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_INSUFFICIENT_STORAGE_EXT,
		eNotMergedDepthStencilCountEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_DEPTH_STENCIL_COUNT_EXT,
		eNotMergedResolveAttachmentReuseEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_RESOLVE_ATTACHMENT_REUSE_EXT,
		eNotMergedSingleSubpassEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_SINGLE_SUBPASS_EXT,
		eNotMergedUnspecifiedEXT = .VK_SUBPASS_MERGE_STATUS_NOT_MERGED_UNSPECIFIED_EXT,
	...
	public enum VkSubmitFlags : uint32
	{
		...
		// Pretty names
		eProtectedBit = .VK_SUBMIT_PROTECTED_BIT,
		eProtectedBitKhr = .VK_SUBMIT_PROTECTED_BIT_KHR,
	...
	public enum VkEventCreateFlags : uint32
	{
		...
		// Pretty names
		eDeviceOnlyBit = .VK_EVENT_CREATE_DEVICE_ONLY_BIT,
	...
	public enum VkPipelineLayoutCreateFlags : uint32
	{
		...
		// Pretty names
		eIndependentSetsBitEXT = .VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT,
	...
	public enum VkProvokingVertexModeEXT : uint32
	{
		...
		// Pretty names
		eFirstVertexEXT = .VK_PROVOKING_VERTEX_MODE_FIRST_VERTEX_EXT,
		eLastVertexEXT = .VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT,
	...
	public enum VkPipelineColorBlendStateCreateFlags : uint32
	{
		...
		// Pretty names
		eRasterizationOrderAttachmentAccessBitArm = .VK_PIPELINE_COLOR_BLEND_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_BIT_ARM,
	...
	public enum VkPipelineDepthStencilStateCreateFlags : uint32
	{
		...
		// Pretty names
		eRasterizationOrderAttachmentDepthAccessBitArm = .VK_PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_ARM,
		eRasterizationOrderAttachmentStencilAccessBitArm = .VK_PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_ARM,
	...
	public enum VkGraphicsPipelineLibraryFlagsEXT : uint32
	{
		...
		// Pretty names
		eVertexInputInterfaceBitEXT = .VK_GRAPHICS_PIPELINE_LIBRARY_VERTEX_INPUT_INTERFACE_BIT_EXT,
		ePreRasterizationShadersBitEXT = .VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT,
		eFragmentShaderBitEXT = .VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT,
		eFragmentOutputInterfaceBitEXT = .VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT,
	...
	public enum VkVideoDecodeH264PictureLayoutFlagsEXT : uint32
	{
		...
		// Pretty names
		eProgressiveEXT = .VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_PROGRESSIVE_EXT,
		eInterlacedInterleavedLinesBitEXT = .VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_INTERLACED_INTERLEAVED_LINES_BIT_EXT,
		eInterlacedSeparatePlanesBitEXT = .VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_INTERLACED_SEPARATE_PLANES_BIT_EXT,
	...
	public enum VkVideoEncodeH264CapabilityFlagsEXT : uint32
	{
		...
		// Pretty names
		eDirect8X8InferenceEnabledBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DIRECT_8X8_INFERENCE_ENABLED_BIT_EXT,
		eDirect8X8InferenceDisabledBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DIRECT_8X8_INFERENCE_DISABLED_BIT_EXT,
		eSeparateColourPlaneBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_SEPARATE_COLOUR_PLANE_BIT_EXT,
		eQpprimeYZeroTransformBypassBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_QPPRIME_Y_ZERO_TRANSFORM_BYPASS_BIT_EXT,
		eScalingListsBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_SCALING_LISTS_BIT_EXT,
		eHrdComplianceBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_HRD_COMPLIANCE_BIT_EXT,
		eChromaQpOffsetBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_CHROMA_QP_OFFSET_BIT_EXT,
		eSecondChromaQpOffsetBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_SECOND_CHROMA_QP_OFFSET_BIT_EXT,
		ePicInitQpMinuS26BitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_PIC_INIT_QP_MINUS26_BIT_EXT,
		eWeightedPredBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_PRED_BIT_EXT,
		eWeightedBipredExplicitBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BIPRED_EXPLICIT_BIT_EXT,
		eWeightedBipredImplicitBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BIPRED_IMPLICIT_BIT_EXT,
		eWeightedPredNoTableBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_PRED_NO_TABLE_BIT_EXT,
		eTransform8X8BitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8_BIT_EXT,
		eCabacBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_CABAC_BIT_EXT,
		eCavlcBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_CAVLC_BIT_EXT,
		eDeblockingFilterDisabledBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED_BIT_EXT,
		eDeblockingFilterEnabledBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED_BIT_EXT,
		eDeblockingFilterPartialBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL_BIT_EXT,
		eDisableDirectSpatialMvPredBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DISABLE_DIRECT_SPATIAL_MV_PRED_BIT_EXT,
		eMultipleSlicePerFrameBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_MULTIPLE_SLICE_PER_FRAME_BIT_EXT,
		eSliceMbCountBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_SLICE_MB_COUNT_BIT_EXT,
		eRowUnalignedSliceBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_ROW_UNALIGNED_SLICE_BIT_EXT,
		eDifferentSliceTypeBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_DIFFERENT_SLICE_TYPE_BIT_EXT,
		eBFrameInL1ListBitEXT = .VK_VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_EXT,
	...
	public enum VkVideoEncodeH264InputModeFlagsEXT : uint32
	{
		...
		// Pretty names
		eFrameBitEXT = .VK_VIDEO_ENCODE_H264_INPUT_MODE_FRAME_BIT_EXT,
		eSliceBitEXT = .VK_VIDEO_ENCODE_H264_INPUT_MODE_SLICE_BIT_EXT,
		eNonVclBitEXT = .VK_VIDEO_ENCODE_H264_INPUT_MODE_NON_VCL_BIT_EXT,
	...
	public enum VkVideoEncodeH264OutputModeFlagsEXT : uint32
	{
		...
		// Pretty names
		eFrameBitEXT = .VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FRAME_BIT_EXT,
		eSliceBitEXT = .VK_VIDEO_ENCODE_H264_OUTPUT_MODE_SLICE_BIT_EXT,
		eNonVclBitEXT = .VK_VIDEO_ENCODE_H264_OUTPUT_MODE_NON_VCL_BIT_EXT,
	...
	public enum VkVideoEncodeH264RateControlStructureFlagsEXT : uint32
	{
		...
		// Pretty names
		eUnknownEXT = .VK_VIDEO_ENCODE_H264_RATE_CONTROL_STRUCTURE_UNKNOWN_EXT,
		eFlatBitEXT = .VK_VIDEO_ENCODE_H264_RATE_CONTROL_STRUCTURE_FLAT_BIT_EXT,
		eDyadicBitEXT = .VK_VIDEO_ENCODE_H264_RATE_CONTROL_STRUCTURE_DYADIC_BIT_EXT,
	...
	public enum VkRenderingFlags : uint32
	{
		...
		// Pretty names
		eContentsSecondaryCommandBuffersBit = .VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT,
		eContentsSecondaryCommandBuffersBitKhr = .VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT_KHR,
		eSuspendingBit = .VK_RENDERING_SUSPENDING_BIT,
		eSuspendingBitKhr = .VK_RENDERING_SUSPENDING_BIT_KHR,
		eResumingBit = .VK_RENDERING_RESUMING_BIT,
		eResumingBitKhr = .VK_RENDERING_RESUMING_BIT_KHR,
	...
	public enum VkVideoEncodeH265CapabilityFlagsEXT : uint32
	{
		...
		// Pretty names
		eSeparateColourPlaneBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SEPARATE_COLOUR_PLANE_BIT_EXT,
		eScalingListsBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SCALING_LISTS_BIT_EXT,
		eSampleAdaptiveOffsetEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SAMPLE_ADAPTIVE_OFFSET_ENABLED_BIT_EXT,
		ePcmEnableBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_PCM_ENABLE_BIT_EXT,
		eSpsTemporalMvpEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SPS_TEMPORAL_MVP_ENABLED_BIT_EXT,
		eHrdComplianceBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_EXT,
		eInitQpMinuS26BitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_INIT_QP_MINUS26_BIT_EXT,
		eLoG2ParallelMergeLevelMinuS2BitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_EXT,
		eSignDataHidingEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SIGN_DATA_HIDING_ENABLED_BIT_EXT,
		eTransformSkipEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_TRANSFORM_SKIP_ENABLED_BIT_EXT,
		eTransformSkipDisabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_TRANSFORM_SKIP_DISABLED_BIT_EXT,
		ePpsSliceChromaQpOffsetsPresentBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_BIT_EXT,
		eWeightedPredBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_WEIGHTED_PRED_BIT_EXT,
		eWeightedBipredBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_WEIGHTED_BIPRED_BIT_EXT,
		eWeightedPredNoTableBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_WEIGHTED_PRED_NO_TABLE_BIT_EXT,
		eTransquantBypassEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_TRANSQUANT_BYPASS_ENABLED_BIT_EXT,
		eEntropyCodingSyncEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_ENTROPY_CODING_SYNC_ENABLED_BIT_EXT,
		eDeblockingFilterOverrideEnabledBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_DEBLOCKING_FILTER_OVERRIDE_ENABLED_BIT_EXT,
		eMultipleTilePerFrameBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILE_PER_FRAME_BIT_EXT,
		eMultipleSlicePerTileBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_PER_TILE_BIT_EXT,
		eMultipleTilePerSliceBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILE_PER_SLICE_BIT_EXT,
		eSliceSegmentCtbCountBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_SLICE_SEGMENT_CTB_COUNT_BIT_EXT,
		eRowUnalignedSliceSegmentBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_EXT,
		eDependentSliceSegmentBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_DEPENDENT_SLICE_SEGMENT_BIT_EXT,
		eDifferentSliceTypeBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_TYPE_BIT_EXT,
		eBFrameInL1ListBitEXT = .VK_VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_EXT,
	...
	public enum VkVideoEncodeH265InputModeFlagsEXT : uint32
	{
		...
		// Pretty names
		eFrameBitEXT = .VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT,
		eSliceSegmentBitEXT = .VK_VIDEO_ENCODE_H265_INPUT_MODE_SLICE_SEGMENT_BIT_EXT,
		eNonVclBitEXT = .VK_VIDEO_ENCODE_H265_INPUT_MODE_NON_VCL_BIT_EXT,
	...
	public enum VkVideoEncodeH265OutputModeFlagsEXT : uint32
	{
		...
		// Pretty names
		eFrameBitEXT = .VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT,
		eSliceSegmentBitEXT = .VK_VIDEO_ENCODE_H265_OUTPUT_MODE_SLICE_SEGMENT_BIT_EXT,
		eNonVclBitEXT = .VK_VIDEO_ENCODE_H265_OUTPUT_MODE_NON_VCL_BIT_EXT,
	...
	public enum VkVideoEncodeH265RateControlStructureFlagsEXT : uint32
	{
		...
		// Pretty names
		eUnknownEXT = .VK_VIDEO_ENCODE_H265_RATE_CONTROL_STRUCTURE_UNKNOWN_EXT,
		eFlatBitEXT = .VK_VIDEO_ENCODE_H265_RATE_CONTROL_STRUCTURE_FLAT_BIT_EXT,
		eDyadicBitEXT = .VK_VIDEO_ENCODE_H265_RATE_CONTROL_STRUCTURE_DYADIC_BIT_EXT,
	...
	public enum VkVideoEncodeH265CtbSizeFlagsEXT : uint32
	{
		...
		// Pretty names
		e16BitEXT = .VK_VIDEO_ENCODE_H265_CTB_SIZE_16_BIT_EXT,
		e32BitEXT = .VK_VIDEO_ENCODE_H265_CTB_SIZE_32_BIT_EXT,
		e64BitEXT = .VK_VIDEO_ENCODE_H265_CTB_SIZE_64_BIT_EXT,
	...
	public enum VkVideoEncodeH265TransformBlockSizeFlagsEXT : uint32
	{
		...
		// Pretty names
		e4BitEXT = .VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_4_BIT_EXT,
		e8BitEXT = .VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_8_BIT_EXT,
		e16BitEXT = .VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_16_BIT_EXT,
		e32BitEXT = .VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_32_BIT_EXT,
	...
	public enum VkExportMetalObjectTypeFlagsEXT : uint32
	{
		...
		// Pretty names
		eMetalDeviceBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_DEVICE_BIT_EXT,
		eMetalCommandQueueBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_COMMAND_QUEUE_BIT_EXT,
		eMetalBufferBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_BUFFER_BIT_EXT,
		eMetalTextureBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_TEXTURE_BIT_EXT,
		eMetalIosurfaceBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_IOSURFACE_BIT_EXT,
		eMetalSharedEventBitEXT = .VK_EXPORT_METAL_OBJECT_TYPE_METAL_SHARED_EVENT_BIT_EXT,
	...
	public enum VkInstanceCreateFlags : uint32
	{
		...
		// Pretty names
		eEnumeratePortabilityBitKhr = .VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR,
	...
	public enum VkImageCompressionFlagsEXT : uint32
	{
		...
		// Pretty names
		eDefaultEXT = .VK_IMAGE_COMPRESSION_DEFAULT_EXT,
		eFixedRateDefaultEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_DEFAULT_EXT,
		eFixedRateExplicitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_EXPLICIT_EXT,
		eDisabledEXT = .VK_IMAGE_COMPRESSION_DISABLED_EXT,
	...
	public enum VkImageCompressionFixedRateFlagsEXT : uint32
	{
		...
		// Pretty names
		eNoneEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_NONE_EXT,
		e1bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_1BPC_BIT_EXT,
		e2bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_2BPC_BIT_EXT,
		e3bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_3BPC_BIT_EXT,
		e4bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_4BPC_BIT_EXT,
		e5bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_5BPC_BIT_EXT,
		e6bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_6BPC_BIT_EXT,
		e7bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_7BPC_BIT_EXT,
		e8bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_8BPC_BIT_EXT,
		e9bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_9BPC_BIT_EXT,
		e10bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_10BPC_BIT_EXT,
		e11bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_11BPC_BIT_EXT,
		e12bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_12BPC_BIT_EXT,
		e13bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_13BPC_BIT_EXT,
		e14bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_14BPC_BIT_EXT,
		e15bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_15BPC_BIT_EXT,
		e16bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_16BPC_BIT_EXT,
		e17bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_17BPC_BIT_EXT,
		e18bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_18BPC_BIT_EXT,
		e19bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_19BPC_BIT_EXT,
		e20bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_20BPC_BIT_EXT,
		e21bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_21BPC_BIT_EXT,
		e22bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_22BPC_BIT_EXT,
		e23bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_23BPC_BIT_EXT,
		e24bpcBitEXT = .VK_IMAGE_COMPRESSION_FIXED_RATE_24BPC_BIT_EXT,
